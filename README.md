...
dates. Trip data is stored locally on-device using Room; a separate REST API
integration is owned and maintained independently by another contributor.
...
- **Saved Places** — keep a shortlist of places to visit for each trip.
...
- **Networking**: out of scope for this module — the REST API client/integration
  layer is owned separately.
